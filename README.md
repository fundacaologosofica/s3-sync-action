...
This simple action uses the [vanilla AWS CLI](https://docs.aws.amazon.com/cli/index.html) to sync a directory (either from your repository or generated during your workflow) with a remote S3 bucket and invalidate cache on CloudFront.
  ...
  deploy:
    ...
    - uses: jakejarvis/s3-sync-action@master
      ...
      env:
        ...
        AWS_REGION: 'sa-west-1'   # optional: defaults to sa-east-1
...
| `AWS_CLOUDFRONT_DISTRIBUTION_ID` | The ID of the CloudFront distribution that needs its cache invalidated. | `secret env` | **Yes** | N/A |
